...
import {
    ...
    Position,
} from '../../interfaces/perfect-scrollbar.interface';
        ...
        if (!this.disabled && isPlatformBrowser(this.platformId)) {
            ...
            this.zone.runOutsideAngular(() => {
                PerfectScrollbarEvents.forEach(
                    (eventName: PerfectScrollbarEvent) => {
    ...
    public scrollToElement(
        ...
        if (element) {
            ...
            if (
                ...
                const position =
                    elementPos.left - scrollerPos.left + currentPos;
            ...
            if (
                this.elementRef.nativeElement.classList.contains('ps--active-y')
            ) {
