...
export class RouterHistoryService {
    previousUrl$: Observable<string> = this.routerHistoryQueryService.findPreviousUrl()
    currentUrl$: Observable<string> = this.routerHistoryQueryService.findCurrentUrl()
    ...
    constructor(
        ...
        router.events
            ...
            .subscribe(async ({ history, currentIndex }) => {
                ...
                const currentState = await this.routerHistoryQueryService.get().toPromise()
